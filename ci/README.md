...
Pipeline running at ${CONCOURSE_URL}/cassandra-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml cassandra-boshrelease --paused=false
```
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml cassandra-boshrelease-image --paused=false
```
